...
const getLocalStorage = () =>
  JSON.parse(localStorage.getItem("db_course")) ?? [];
const setLocalStorage = (dbCourse) =>
  localStorage.setItem("db_course", JSON.stringify(dbCourse));
...
document
  .querySelector("#tabelaCourse>tbody")
  .addEventListener("click", editarDelete);

document.getElementById("cancel").addEventListener("click", closeModal);

document
  .getElementById("change-tema")
  .addEventListener("change", changeTemaBtn);
